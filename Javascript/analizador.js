  ...
  analizar_cadenaTemp(cadena) {
    // Método principal para el análisis léxico
      ...
      while (q !== this.q_final && q !== this.q_error && this.indice < cadenaTemp.length) {
          ...
          switch (q) {
            // Aquí se definen los estados y transiciones
              case 0:
...
document.getElementById("fileInput").addEventListener("change", function (e) {
    ...
    reader.onload = function () {
        ...
        // Llamar a analizarTexto después de cargar el archivo
        analizarTexto();
    };
